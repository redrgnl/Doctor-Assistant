<?php
  session_start();
  include_once("../BackEnd/pages/php/doctor_db.php");
  $id = $_GET['id'];
  ...
  $tips = query("SELECT * FROM artikel");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <h1 class="mb-3 bread" style="color: white;">info Kesehatan</h1>
          </div>
        </div>
      </div>
    </div>
              ...
              <ul class="comment-list">
                ...
                <li class="comment">
                  <div class="comment-body">
                    ...
                    <p><?php echo "<a href='tips.php?id=$row[id]' class='reply'>Selengkapnya</a>" ?></p>
                  </div>
                </li>
                <?php endforeach; ?>
              </ul>
